...
public class openArmLow extends CommandBase {
  ...
  public openArmLow(PistonedTelescopicArm arm,Intake intake) {
    _arm=arm; 
    _intake=intake;
    isZero = true;
    can_go_down1=true;
  ...
  public void execute() {
    ...
    if(_arm.get_pot__position()<2.17)
    {
      _arm.stop_arm();
      already_opened=false;

      if(_arm.get_arm_motor().getSelectedSensorPosition()<5000)
      {
